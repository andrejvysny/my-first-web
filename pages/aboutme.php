...
<link rel="stylesheet" type="text/css" href="pages/styles/aboutme.css" />
...
<div class="container">
	...
	<article class="right">
		...
		<img class="portrait" src="pages/styles/images/me.jpg"  alt="Andrej Vyšný">
		<p class="textaboutme" > <?php echo $textaboutme; ?></p>
	</article>	
</div>
